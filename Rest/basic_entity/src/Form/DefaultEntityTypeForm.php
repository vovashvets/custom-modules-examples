...
class DefaultEntityTypeForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\basic_entity\Entity\DefaultEntityType::load',
      ],
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        drupal_set_message($this->t('Created the %label Default entity type.', [
          '%label' => $default_entity_type->label(),
        ]));
        break;

      default:
        drupal_set_message($this->t('Saved the %label Default entity type.', [
          '%label' => $default_entity_type->label(),
        ]));
    }
